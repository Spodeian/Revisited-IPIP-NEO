...
<#
.SYNOPSIS
    Builds the Revisited IPIP-NEO app as an Android shared library (.so) via cargo-ndk.
.DESCRIPTION
...
Write-Host "============================================================"
Write-Host " Building Revisited IPIP-NEO for Android via cargo-ndk"
Write-Host "============================================================"
...
if (-not $env:ANDROID_NDK_HOME -and -not $env:NDK_HOME) {
    ...
    Write-Warning "Ensure Android NDK is installed and ANDROID_NDK_HOME points to your NDK path."
}
