            ...
            ui.horizontal(|ui| {
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    ...
                    ui.menu_button(egui::RichText::new("☰  Menu").strong(), |ui| {
                        ...
                        let (results_icon, results_text) = if self.state.questionnaire.show_results {
                            ("📝", "Return to Questions")
                        } else {
                            ("📊", "View Assessment Results")
                        };
                        if ui
                            .button(format!("{}  {}", results_icon, results_text))
                            .on_hover_text("Toggle between questionnaire answering view and hierarchical results report")
                            .clicked()
                        {
                        ...
                        if ui
                            .button("⊞  Item Matrix Map")
                            .on_hover_text("Open interactive 221-item questionnaire matrix map")
                            .clicked()
                        {
                        ...
                        if self.is_viewing_shared_link
                            && ui
                                .button("↩  Return to Saved Answers")
                                .on_hover_text("Exit shared link view and restore locally saved assessment")
                                .clicked()
                        {
                        ...
                        if ui
                            .button("📥  Import Answers (CSV, JSON, BSON)")
                            .on_hover_text("Import assessment backup from CSV, JSON, or BSON file")
                            .clicked()
                        {
                        ...
                        if ui
                            .button("🗑  Reset Assessment")
                            .on_hover_text("Clear all recorded responses and restart assessment from item #1")
                            .clicked()
                        {
                        ...
                        if ui
                            .button(storage_label)
                            .on_hover_text("Inspect offline storage durability, persistence mode, quota, and backups")
                            .clicked()
                        {
                        ...
                        if self.storage_diag.pwa_install_available
                            ...
                            && ui
                                .button("📲  Install App (PWA)")
                                .on_hover_text("Install assessment as a standalone Progressive Web App for offline durability")
                                .clicked()
                        {
                            trigger_pwa_install();
                            ui.close();
                        ...
                        let theme_label = format!("{}  Theme: {}", theme_icon, self.state.config.theme.label());
                        if ui
                            .button(theme_label)
                            .on_hover_text("Cycle visual themes between Dark, Light, and High Contrast modes")
                            .clicked()
                        {
                        ...
                        if ui
                            ...
                            .on_hover_text("View instructions, psychometric background, keyboard shortcuts, and data privacy")
                            .clicked()
                        {
                        ...
                        if ui
                            .button("📄  Research Paper (DOI)")
                            .on_hover_text("Open published research paper in European Journal of Personality (DOI)")
                            .clicked()
                        {
                        ...
                        if ui
                            ...
                            .on_hover_text("Open open-source repository and codebase on GitHub")
                            .clicked()
                        {
                        ...
                        ui.separator();
                        if ui
                            .button("▲  Hide Header Bar")
                            .on_hover_text("Collapse top navigation header to maximize questionnaire workspace")
                            .clicked()
                        {
                    ...
                    let results_btn_label = if self.state.questionnaire.show_results {
                        "📝  Questions"
                    } else {
                        "📊  Results"
                    };
                    let mut res_btn = egui::Button::new(egui::RichText::new(results_btn_label).strong());
                    if is_touch {
