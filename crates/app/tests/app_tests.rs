...
fn test_personality_app_save_and_load() {
    ...
    app.state
        .questionnaire
        .answer_question(0, Response::StronglyAgree);
...
fn test_shared_link_does_not_overwrite_persistent_state() {
    ...
    assert_eq!(
        initial_loaded.questionnaire.questions[0].response,
        Some(Response::StronglyAgree)
    );
    ...
    shared_app
        .state
        .questionnaire
        .answer_question(0, Response::Disagree);
    shared_app
        .state
        .questionnaire
        .answer_question(1, Response::Agree);
    ...
    shared_app
        .state
        .questionnaire
        .answer_question(0, Response::Neutral);
...
fn test_restore_saved_instance() {
    ...
    assert_eq!(
        app.state.questionnaire.questions[0].response,
...
fn test_import_from_bytes_all_formats() {
    ...
    source_app
        .state
        .questionnaire
        .answer_question(1, Response::Disagree);
    ...
    assert_eq!(
        app_csv.state.questionnaire.questions[0].response,
        Some(Response::StronglyAgree)
    );
    assert_eq!(
        app_csv.state.questionnaire.questions[1].response,
        Some(Response::Disagree)
    );
    ...
    assert_eq!(res.unwrap(), 2);
    assert_eq!(
        app_json.state.questionnaire.questions[0].response,
        Some(Response::StronglyAgree)
    );
    assert_eq!(
        app_json.state.questionnaire.questions[1].response,
        Some(Response::Disagree)
    );
    ...
    assert_eq!(res.unwrap(), 2);
    assert_eq!(
        app_bson.state.questionnaire.questions[0].response,
        Some(Response::StronglyAgree)
    );
    assert_eq!(
        app_bson.state.questionnaire.questions[1].response,
        Some(Response::Disagree)
    );
    ...
    assert_eq!(res.unwrap(), 2);
    assert_eq!(
        app_b64.state.questionnaire.questions[0].response,
        Some(Response::StronglyAgree)
    );
    assert_eq!(
...
fn test_load_state_multi_tier_json_and_ron() {
    ...
    original_state
        .questionnaire
        .answer_question(1, Response::Neutral);
    ...
    assert_eq!(
        from_json.questionnaire.questions[0].response,
        Some(Response::StronglyAgree)
    );
    ...
    assert_eq!(
        from_ron.questionnaire.questions[0].response,
        Some(Response::StronglyAgree)
    );
...
fn test_results_persistence_and_completion_restoration() {
    ...
    assert_eq!(
        loaded.questionnaire.questions[0].response,
        Some(Response::Agree)
    );
